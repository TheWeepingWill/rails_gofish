# Overview
## Name and aliases
The project is named "RailsFullStackGoFish". Some will refer to it as "<alias1>" or "<alias2>".
...
git clone http://github.com/RoleModel/rails_full_stack_go_fish
cd rails_full_stack_go_fish
rbenv install
gem install bundler
bundle install
\```
...
# Links to:
## [Git repo](http://github.com/RoleModel/rails_full_stack_go_fish)
